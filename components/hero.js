...
export default function Hero() {
  ...
  return (
    <>
      <div className="transition-all min-h-[60vh] flex flex-col-reverse md:items-center justify-start items-start md:justify-center md:flex-row md:mt-10  py-2 ml-1 font-Ubuntu temp">
